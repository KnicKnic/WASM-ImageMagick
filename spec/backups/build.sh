...
export CPPFLAGS="-I~/.emscripten_ports/zlib/zlib-version_1/ -I~/.emscripten_ports/libpng/libpng-version_1 -I/code/libjpeg -I/code/libtiff/libtiff -I~/.emscripten_ports/freetype/FreeType-version_1/include/"
...
export LDFLAGS="-L/code/libjpeg -L/code/libtiff/libtiff"

export CFLAGS="-O3"

export CXXFLAGS="$CFLAGS"

export MAKE_FLAGS="-s BINARYEN_TRAP_MODE=clamp -s ALLOW_MEMORY_GROWTH=1 -s EXIT_RUNTIME=1 -s USE_ZLIB=1 -s USE_LIBPNG=1 -s USE_HARFBUZZ=1 -s USE_FREETYPE=1 "
...
export PKG_CONFIG_PATH="/code/libjpeg:/code/libtiff:/code/libtiff/libtiff:~/.emscripten_ports/freetype/FreeType-version_1/builds/unix:~/.emscripten_ports/zlib/zlib-version_1:~/.emscripten_ports/libpng/libpng-version_1:"
...
# emcc -s USE_ZLIB=1  -v --cflags
# cd ~/.emscripten_ports/zlib/zlib-version_1
# emconfigure ./configure


# emcc -s USE_ZLIB=1 -s USE_LIBPNG=1  -v --cflags
# cd ~/.emscripten_ports/libpng/libpng-version_1
# libtoolize
# automake --add-missing
# emconfigure ./configure
# emcmake make  -s USE_ZLIB=1



# emcc -s USE_ZLIB=1 -s USE_LIBPNG=1 -s USE_HARFBUZZ=1  -v --cflags
# cd ~/.emscripten_ports/harfbuzz/harfbuzz-1.7.5
# emconfigure ./configure

# emcc -s USE_ZLIB=1 -s USE_LIBPNG=1 -s USE_HARFBUZZ=1 -s USE_FREETYPE=1  -v --cflags
# cd ~/.emscripten_ports/freetype/FreeType-version_1
# emconfigure ./configure


# # cd /code/zlib
# # emconfigure $MAKE_FLAGS ./configure --static
...
# # link
# /bin/bash ./libtool --tag=CC --mode=link emcc $MAKE_FLAGS $CXXFLAGS $LDFLAGS -o utilities/magick.html utilities/magick.o MagickCore/libMagickCore-7.Q16HDRI.la MagickWand/libMagickWand-7.Q16HDRI.la 
