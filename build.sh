export CPPFLAGS="-I/code/prefix/include -I$HOME/.emscripten_ports/freetype/FreeType-version_1/include -I$HOME/.emscripten_ports/libpng/libpng-version_1 -I$HOME/.emscripten_ports/zlib/zlib-version_1 "
...
emcmake make CFLAGS="$CFLAGS -s ERROR_ON_UNDEFINED_SYMBOLS=0"
