...
/**
 * Represents input files that need to be provided to {@link call} or {@link execute}.
 * 
...
/**
 * The result of calling {@link call}. Also the base class of results of calling {@link execute}.
 */
...
/**
 * Low level execution function. All the other functions like {@link execute} ends up calling this one. It accept only one command and only in the form of array of strings.
 */
