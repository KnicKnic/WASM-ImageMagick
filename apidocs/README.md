...
Let's consider the following [execute](interfaces/executioncontext.md#execute) call:
...
*   See [execute](interfaces/executioncontext.md#execute) and [executeAndReturnOutputFile](#executeandreturnoutputfile) for information on how to execute commands. Also [ExecuteResult](interfaces/executeresult.md) and [ExecuteConfig](interfaces/executeconfig.md).
...
*Defined in [execute.ts:7](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/execute.ts#L7)*
...
*Defined in [execute.ts:49](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/execute.ts#L49)*
...
*Defined in [util/support.ts:8](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/util/support.ts#L8)*
...
*Defined in [magickApi.ts:27](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/magickApi.ts#L27)*
...
*Defined in [execute.ts:125](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/execute.ts#L125)*
...
*Defined in [util/cli.ts:26](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/util/cli.ts#L26)*
...
*Defined in [util/cli.ts:89](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/util/cli.ts#L89)*
...
*Defined in [execute.ts:88](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/execute.ts#L88)*
...
*Defined in [util/file.ts:66](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/util/file.ts#L66)*
...
*Defined in [magickApi.ts:57](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/magickApi.ts#L57)*

Low level execution function. All the other functions like [execute](interfaces/executioncontext.md#execute) ends up calling this one. It accept only one command and only in the form of array of strings.
...
*Defined in [util/cli.ts:66](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/util/cli.ts#L66)*
...
*Defined in [util/imageCompare.ts:6](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/util/imageCompare.ts#L6)*
...
*Defined in [util/imageCompare.ts:11](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/util/imageCompare.ts#L11)*
...
*Defined in [execute.ts:159](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/execute.ts#L159)*
...
*Defined in [execute.ts:104](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/execute.ts#L104)*
...
*Defined in [execute.ts:59](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/execute.ts#L59)*
...
*Defined in [util/imageExtractInfo.ts:8](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/util/imageExtractInfo.ts#L8)*
...
*Defined in [util/file.ts:78](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/util/file.ts#L78)*
...
*Defined in [util/file.ts:90](https://github.com/KnicKnic/WASM-ImageMagick/blob/7684a1c/src/util/file.ts#L90)*
